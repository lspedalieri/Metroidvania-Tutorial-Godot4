...
@onready var windows_mode_option_button: OptionButton = $MarginContainer/PanelContainer/MarginContainer/VBoxContainer/WindowsModeOptionButton
...
func _ready():
	print("settings menu screen")
	for window_mode in window_modes:
		windows_mode_option_button.add_item(window_mode)
...
func initialise_controls():
	...
	windows_mode_option_button.selected = settings_data.window_mode_index
	resolution_option_button.selected = settings_data.resolution_index


func _on_windows_mode_option_button_item_selected(index):
	var window_mode = window_modes.get(windows_mode_option_button.get_item_text(index)) as int
